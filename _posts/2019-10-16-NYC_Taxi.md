...
Next the timestamps are converted to unix in our data we have time in the formate "YYYY-MM-DD HH:MM:SS" we convert this string to python time formate and then into unix time stamp.
